...
REGRAS DE FORMATO DAS ANÁLISES (OBRIGATÓRIO):
- Use exatamente: '- Título da Categoria: Descrição'.
...
- Em seguida informe esses aspectos em bullet points ('-') de forma objetiva:
    ...
    6. Indique o valor do ICT e se ele está aumentado. Caso não esteja, sinalizar a normalidade. (análise 4)
...
"""
    ...
    response = llm.invoke(messages, reasoning=THINKING)
